...
/* [_QWERTY_SOFT] = LAYOUT( \
  ...
  KC_TAB,   KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                     KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN,  KC_QUOT, \
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     KC_MPLY,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT, \
                 KC_LGUI,KC_LALT,KC_LCTRL, KC_F23, KC_SPC,      KC_ENT,  KC_F24, KC_RCTRL, KC_RALT, KC_RGUI \
),
 */
...
[_LOWER] = LAYOUT( \
    ...
    KC_TRNS, KC_MINS, KC_P4, KC_P5, KC_P6, KC_PMNS,                         KC_PGDN, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, \
...
[_RAISE] = LAYOUT( \
    ...
    KC_TRNS, KC_SCLN, KC_LCBR, KC_LPRN, KC_LBRC, KC_LT,                 KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_DEL, KC_BSPC, \
    KC_TRNS, KC_DOT, KC_RCBR, KC_RPRN, KC_RBRC, KC_GT, KC_TRNS,      KC_TRNS, KC_NO, KC_HOME, KC_NO, KC_END, KC_NO, KC_TRNS, \

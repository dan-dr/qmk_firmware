...
[_COLEMAK_DH] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_D,    KC_V, KC_MUTE,      XXXXXXX,KC_K,    KC_H, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT, \
                 KC_LCTRL,KC_LGUI,KC_LALT,KC_LOWER, KC_SPC,      KC_ENT,  KC_RAISE, KC_RGUI,KC_RALT,KC_RCTRL  \
),
...
[_COLEMAK_DH_SOFT] = LAYOUT( \
  ...
  KC_TAB,   KC_A,   KC_R,    KC_S,    KC_T,    KC_G,                      KC_M,    KC_N,    KC_E,    KC_I,    KC_O,  KC_QUOT, \
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_D,    KC_V, KC_MUTE,      XXXXXXX,KC_K,    KC_H, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT, \
                 KC_LCTRL,KC_LGUI,KC_LALT,KC_F23, KC_SPC,      KC_ENT,  KC_F24, KC_RGUI,KC_RALT,KC_RCTRL  \
),
